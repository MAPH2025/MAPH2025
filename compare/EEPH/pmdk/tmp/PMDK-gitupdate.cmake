...
execute_process(
  COMMAND "/usr/bin/git" show-ref "addr-patch"
  WORKING_DIRECTORY "/home/cq/dash/build/pmdk/src/PMDK"
...
if("${show_ref_output}" MATCHES "refs/remotes/addr-patch")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "addr-patch")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "addr-patch")
endif()
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/HaoPatrick/pmdk.git'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/home/cq/dash/build/pmdk/src/PMDK'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/cq/dash/build/pmdk/src/PMDK'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
